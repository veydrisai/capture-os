      ...
      <main className="app-main">
        ...
        <div className="mobile-topbar">
          <button
            ...
            style={{ background: "none", border: "none", color: "rgba(255,255,255,0.7)", cursor: "pointer", padding: 12, display: "flex", alignItems: "center", borderRadius: 8 }}
          >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <img src="/logo.svg" alt="CaptureOS" style={{ width: 28, height: 28, borderRadius: 8, objectFit: "contain", boxShadow: "0 2px 10px rgba(212,175,110,0.25)" }} />
