                ...
                <div style={{ flex: 1, overflowY: "auto", padding: "10px 10px 8px", display: "flex", flexDirection: "column", gap: 7, scrollbarWidth: "none", minHeight: 120 }}>
                  ...
                  {stageLeads.length === 0 && (
                    <div style={{ padding: "24px 8px", textAlign: "center", opacity: 0.35 }}>
                      ...
                      <p style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", fontWeight: 500 }}>No leads</p>
                    </div>
                  )}
                  ...
                  {stageLeads.map((lead) => (
                    ...
                    >
                      ...
                      {lead.estimatedValue > 0 && (
                        <p style={{ fontSize: 12, fontWeight: 700, color: stage.color, marginTop: 6 }}>${lead.estimatedValue.toLocaleString()}</p>
                      )}
                    </div>
                  ))}
