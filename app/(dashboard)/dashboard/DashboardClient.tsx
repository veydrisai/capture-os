...
const stageColor: Record<string, string> = {
  cold_outreach: "#4ADE80", demo_booked: "#86EFAC", demo_done: "#22C55E",
...
export default function DashboardClient({ firstName, stats, greeting }: { firstName: string; stats: Stats; greeting: string }) {
  const kpis = [
    { label: "Demos Booked",       sublabel: "this week",     value: stats.demosBooked.toString(),        icon: Calendar,   color: "#22C55E", glow: "rgba(34,197,94,0.32)",  bg: "rgba(34,197,94,0.12)" },
    ...
    { label: "MRR",                sublabel: "from live clients", value: `$${stats.mrr.toLocaleString()}`, icon: DollarSign, color: "#86EFAC", glow: "rgba(134,239,172,0.32)", bg: "rgba(134,239,172,0.12)" },
  ];
    ...
    <div className="animate-fade-up">
      ...
      {stats.pipelineValue > 0 && (
        <div className="glass-sm" style={{ padding: "12px 18px", marginBottom: 24, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <span style={{ fontSize: 16, fontWeight: 700, color: "#86EFAC" }}>${stats.pipelineValue.toLocaleString()}</span>
        </div>
      )}
      ...
      <div className="grid-2col">
        <div className="glass" style={{ padding: 22 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
            ...
            <Link to="/deals" prefetch="intent" style={{ display: "flex", alignItems: "center", gap: 3, fontSize: 12, color: "rgba(34,197,94,0.90)", textDecoration: "none", fontWeight: 500 }}>
        ...
        <div className="glass" style={{ padding: 22 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
            ...
            <Link to="/activity" prefetch="intent" style={{ display: "flex", alignItems: "center", gap: 3, fontSize: 12, color: "rgba(34,197,94,0.90)", textDecoration: "none", fontWeight: 500 }}>
              View all <ArrowUpRight size={11} />
            </Link>
          </div>
