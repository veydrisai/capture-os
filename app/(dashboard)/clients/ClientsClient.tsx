...
const statusColor: Record<string, { color: string; bg: string; border: string }> = {
  ...
  intake_sent:         { color: "#c7d2fe", bg: "rgba(99,102,241,0.12)", border: "rgba(99,102,241,0.25)" },
  ...
  building:            { color: "#ddd6fe", bg: "rgba(139,92,246,0.12)", border: "rgba(139,92,246,0.25)" },
                ...
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16 }}>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
                      ...
                      {client.systemType && <span style={{ fontSize: 10.5, color: "rgba(167,139,250,0.85)", background: "rgba(139,92,246,0.12)", border: "1px solid rgba(139,92,246,0.2)", borderRadius: 6, padding: "1px 7px", fontWeight: 500 }}>{systemLabel[client.systemType]}</span>}
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                      <div style={{ flex: 1, height: 4, background: "rgba(255,255,255,0.07)", borderRadius: 3 }}>
                        <div style={{ height: "100%", width: `${pct}%`, background: pct === 100 ? "#4ade80" : "linear-gradient(90deg,#6366f1,#8b5cf6)", borderRadius: 3 }} />
                      </div>
