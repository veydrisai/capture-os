        ...
        <div className="glass" style={{ padding: 24 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            {user?.image ? (
              ...
              <div style={{ width: 56, height: 56, borderRadius: "50%", background: "linear-gradient(135deg, #16A34A, #22C55E)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, fontWeight: 600, color: "white" }}>
            ...
            <div>
              ...
              <span style={{ fontSize: 11, color: "#a5b4fc", background: "rgba(22,163,74,0.12)", padding: "2px 8px", borderRadius: 6, marginTop: 4, display: "inline-block" }}>Admin</span>
            </div>
          </div>
        </div>
        ...
        <div className="glass" style={{ padding: 24 }}>
          ...
          <form onSubmit={handleSave} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, paddingTop: 4 }}>
              <button type="submit" disabled={saving} style={{ display: "flex", alignItems: "center", gap: 7, padding: "9px 18px", borderRadius: 10, background: "linear-gradient(135deg, #16A34A, #22C55E)", border: "none", color: "white", fontSize: 13, fontWeight: 500, cursor: saving ? "not-allowed" : "pointer", opacity: saving ? 0.7 : 1 }}>
        ...
        <div className="glass" style={{ padding: 24 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <a href="https://app.cal.com/settings/developer/api-keys" target="_blank" rel="noopener noreferrer" style={{ fontSize: 11, color: "#a5b4fc", background: "rgba(22,163,74,0.1)", padding: "3px 10px", borderRadius: 6, textDecoration: "none" }}>
                Get API key →
              </a>
            </div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <a href="https://resend.com/api-keys" target="_blank" rel="noopener noreferrer" style={{ fontSize: 11, color: "#a5b4fc", background: "rgba(22,163,74,0.1)", padding: "3px 10px", borderRadius: 6, textDecoration: "none" }}>
                Get API key →
              </a>
            </div>
          </div>
