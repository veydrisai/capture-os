  ...
  const navActions = (
    <>
      ...
      <a
        ...
        style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", borderRadius: 10, background: "linear-gradient(135deg, #16A34A, #22C55E)", color: "white", fontSize: 13, fontWeight: 500, textDecoration: "none" }}
      >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)" }}>
            {days.map((day, i) => {
              ...
              return (
                ...
                >
                  <div style={{ width: 24, height: 24, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: today ? 600 : 400, color: today ? "white" : inMonth ? "rgba(255,255,255,0.7)" : "rgba(255,255,255,0.2)", background: today ? "linear-gradient(135deg, #16A34A, #22C55E)" : "transparent", marginBottom: 4 }}>
                    {format(day, "d")}
                  </div>
