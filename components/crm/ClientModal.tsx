          ...
          <div style={bodyStyle}>
            ...
            <div style={{ display: "flex", gap: 10, alignItems: "flex-end" }}>
              ...
              <button
                ...
                style={{ flexShrink: 0, display: "flex", alignItems: "center", gap: 7, padding: "11px 16px", borderRadius: 12, background: intakeSent ? "rgba(34,197,94,0.1)" : "linear-gradient(135deg,rgba(22,163,74,0.2),rgba(34,197,94,0.15))", border: `1px solid ${intakeSent ? "rgba(34,197,94,0.3)" : "rgba(22,163,74,0.3)"}`, color: intakeSent ? "#86efac" : "rgba(255,255,255,0.75)", fontSize: 13, fontWeight: 500, fontFamily: "inherit", cursor: sendingIntake ? "default" : "pointer", opacity: sendingIntake ? 0.7 : 1, whiteSpace: "nowrap" }}
              >
                <Send size={13} />
