          ...
          {step === "upload" && (
            <div>
              <div
                ...
                style={{ border: "2px dashed rgba(99,102,241,0.3)", borderRadius: 16, padding: "48px 32px", textAlign: "center", cursor: "pointer", background: "rgba(99,102,241,0.04)", transition: "all 0.15s" }}
                ...
                onMouseLeave={(e) => { (e.currentTarget as HTMLDivElement).style.borderColor = "rgba(99,102,241,0.3)"; (e.currentTarget as HTMLDivElement).style.background = "rgba(99,102,241,0.04)"; }}
              >
                <Upload size={28} color="rgba(99,102,241,0.6)" style={{ margin: "0 auto 12px" }} />
              ...
              <div style={{ marginTop: 20, padding: "16px 20px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 12 }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                  {["First Name", "Last Name", "Email", "Phone", "Company", "Industry", "Source", "System Interest", "Estimated Value", "Notes"].map((h) => (
                    <span key={h} style={{ fontSize: 11, padding: "3px 8px", borderRadius: 6, background: "rgba(99,102,241,0.12)", color: "rgba(167,139,250,0.8)", border: "1px solid rgba(99,102,241,0.2)" }}>{h}</span>
                  ))}
                </div>
